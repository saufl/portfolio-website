...
document.addEventListener("DOMContentLoaded", function() {
    // Default open "Projects" tab
    document.querySelector('.tablinks[onclick="openTab(event, \'project\')"]').click();
});
...
downloadButtons.forEach(button => {
  button.addEventListener('click', handleDownloadCVClick);
});
// SOCIAL ICON FUNCTION
document.getElementById("igIcon").addEventListener("click", function() {
  window.open("https://www.instagram.com/saufl_", "_blank");
});

document.getElementById("linkedinIcon").addEventListener("click", function() {
  window.open("https://www.linkedin.com/in/syaeful-permana", "_blank");
});

document.getElementById("githubIcon").addEventListener("click", function() {
  window.open("https://github.com/saufl", "_blank");
});
